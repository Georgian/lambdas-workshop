...
public class B_Comparators {
    ...
    public void comparator01() {
        ...
        assertEquals(0, compareByLength.compare("ONE", "TWO"));
    }
    // Hint:
    ...
    public void comparator02() {
        ...
        assertEquals(0, compareByLengthThenAlphabetical.compare("EIGHT", "EIGHT"));
    }
    // Hint:
    // <editor-fold defaultstate="collapsed">
    ...
    public void comparator03() {
        Comparator<Person> compareLastName = Comparator.comparing(Person::lastName);

        assertTrue(compareLastName.compare(michael, rod) < 0);
        assertEquals(0, compareLastName.compare(paul, paul));
        assertTrue(compareLastName.compare(michael, jermaine) > 0);
    }
    // Hint:
    // <editor-fold defaultstate="collapsed">
    // Check the static factory methods of the Comparator interface. Remember
    ...
    public void comparator04() {
        ...
        assertEquals(0, comparebyLastNameThenFirstName.compare(paul, paul));
    ...
    public void comparator05() {
        ...
        assertEquals(0, comparebyLastNameThenFirstNameReversed.compare(paul, paul));
    ...
    public void comparator06() {
        ...
        assertEquals(0, comparebyLastNameThenFirstNameWithNull.compare(paul, paul));
